...
public class AttackStrategy_AquamarineTower : IAttackStrategy
{
    public IEnumerator Attack(BaseTower tower)
    {
        ...
        EffectManager.Instance.TriggerAOE(centerPos, new Color(30f / 255f, 160f / 255f, 120f / 255f, 50f/ 255f), tower.statHandler.AttackRange + 0.5f);
